...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(essayscoringtool.EssayScoringToolApp.class).getContext().getResourceMap(LoginFrame.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
           ...
           throw new Exception("All Fields Are Mandatory ");
            ...
            File temp=new File("d:\\essayusers.txt");
            if(temp.exists()==false) 
                 throw new Exception("No Users Yet Registered For This Application ");
            
        FileInputStream fis=new FileInputStream("d:\\essayusers.txt");
        ...
        while(line!=null)
        {
            if(line.split(",")[0].equals(txtUserName.getText()) && line.split(",")[1].equals(txtPassword.getText()))
            {
                flag=true;
                break;
            }
        ...
        if(flag==true && jComboBox1.getSelectedIndex()==1)
        {
                     MenuFrame mf=new MenuFrame(jComboBox1.getSelectedItem().toString());
             this.setVisible(false);
             mf.setVisible(true);
        }
     else
      JOptionPane.showMessageDialog(this,"Invalid User ReLogin");
        }
        catch(Exception ex)
        {
